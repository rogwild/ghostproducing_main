                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-10">
                                                <form role="form" class="mb-10">
                                                    <div class="btn-group uppercase m-0" data-toggle="buttons">
                                                      <label class="btn btn-default" data-toggle="collapse" data-target="#track">
                                          ...
                                          <div class="panel-group" id="accordion">
                                              <div class="panel panel-default">
                                                <div class="row panel-collapse collapse" data-parent="#accordion"  id="track">
                                                    <form method='POST' action="/profile/{user}/add_track" enctype="multipart/form-data">
                                                      ...
                                                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                             ...
                                                             <input type="text" name="name" class="form-control" id="InputNameTrack" placeholder="TRACK">
                                                            </div>
                                                      </div> 
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="sequencer" class="form-control">
                                                      ...
                                                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                             ...
                                                             <input type="number" name="bpm" class="form-control" id="InputSpeedTrack" placeholder="BPM">
                                                            </div>
                                                       </div>
                                                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                             ...
                                                             <input type="text" name="megalink" class="form-control" id="MegaLink" placeholder="MEGA Link">
                                                            </div>
                                                       </div>
                                                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                             <label for="InputPriceTrack">стоимость</label>
                                                             <input type="number" name="price" class="form-control" id="InputPriceTrack" placeholder="РУБЛЕЙ">
                                                            </div>
                                                       </div>
                                                        <div class="form-group">
